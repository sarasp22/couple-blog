const EVENTS = [
  {
    ...
    body_it: "Dopo il match, abbiamo passato dieci ore al telefono, come se ci conoscessimo già da tempo. Era mercoledi ed io avevo deciso che volevo che ci vedessimo domenica, ma con le tue tecniche persuasive sei riuscito momento dopo momento ad anticipare sempre di piu il nostro incontro, finché abbiamo deciso di non aspettare oltre: il giorno dopo, subito dopo il lavoro, ci saremmo visti. Jordan mi aveva detto di raggiungerlo vicino a un ponte… peccato che avesse sbagliato il nome. Avevo paura mi avesse dato buca. Così, tra una risata e una chiamata improvvisata, abbiamo iniziato ad avvicinarci l’uno all’altra, guidati dalla voce più che dalla mappa. Ci siamo trovati davanti alla statua di Châtelet. Lui era elegantissimo, io decisamente più sportiva. Ho notato subito il suo sorriso, uno di quelli che ti fanno pensare: “niente male”. Gli avevo detto chiaramente che non volevo essere toccata, e lui ha rispettato questa cosa per tutto il tempo, mantenendo una distanza quasi buffa ma piena di attenzione. Tra qualche piccolo battibecco e tante chiacchiere, l’appuntamento è volato. E alla fine, contro ogni mia previsione iniziale, Jordan si è guadagnato un abbraccio. Il primo di tanti altri.",
    body_fr: "Après le match, nous avons passé dix heures au téléphone, comme si nous nous connaissions déjà depuis longtemps. C’était mercredi et j’avais décidé que je voulais qu’on se voie dimanche, mais avec tes techniques de persuasion, tu as réussi, petit à petit, à avancer notre rendez-vous, jusqu’à ce qu’on décide de ne plus attendre : le lendemain, juste après le travail, on allait se voir. Jordan m’avait dit de le rejoindre près d’un pont… sauf qu’il s’était trompé de nom. J’ai eu peur qu’il m’ait posé un lapin. Alors, entre un rire et un appel improvisé, on a commencé à se rapprocher l’un de l’autre, guidés plus par nos voix que par la carte. On s’est retrouvés devant la statue de Châtelet. Lui était très élégant, moi beaucoup plus sportive. J’ai tout de suite remarqué son sourire, de ceux qui te font penser : « pas mal du tout ». Je lui avais clairement dit que je ne voulais pas qu’il me touche, et il a respecté ça pendant tout le rendez-vous, en gardant une distance presque drôle mais pleine d’attention. Entre quelques petits désaccords et beaucoup de discussions, le rendez-vous est passé en un instant. Et à la fin, contre toute attente, Jordan a gagné un câlin. Le premier d’une longue série.",
